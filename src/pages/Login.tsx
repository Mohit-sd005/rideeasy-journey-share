          ...
          <Card className="border-0 shadow-xl">
            <CardHeader className="pb-8">
              ...
              <CardTitle className="text-2xl font-bold text-center">
                Log in as a {role?.charAt(0).toUpperCase() + role?.slice(1)}
              </CardTitle>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <Link to="/forgot-password" className="text-sm text-rideeasy-purple hover:underline">
                      Forgot password?
                    </Link>
                  </div>
                  <Input
            ...
            <CardFooter>
              <div className="text-center w-full text-sm">
                ...
                <Link to={`/signup/${role}`} className="text-rideeasy-purple hover:underline font-medium">
                  Sign up
                </Link>
              </div>
            </CardFooter>
